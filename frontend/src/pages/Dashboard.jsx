...
function Dashboard() {
  ...
  <div className="bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200 p-5 flex justify-between items-start shadow-sm hover:shadow-md transition-shadow">
    <div className="flex flex-col">
      ...
      <span className="text-sm text-gray-500">+{monthlyCount} this month</span>
    </div>
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      ...
      <main className="flex-1 md:pt-[5vh] md:pl-[20%] px-4 md:px-6 pb-10">
        <h1 className="font-bold text-xl text-gray-700 mb-6">
...
{/* <StatCard
 ...
 /> */}
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
          {loading ? (
            <>
              <div className="bg-white/80 backdrop-blur-sm h-40 rounded-lg animate-pulse border border-gray-200" />
              <div className="bg-white/80 backdrop-blur-sm h-40 rounded-lg animate-pulse border border-gray-200" />
            </>
          ) : (
            <>
