...
function RecentProjects() {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-md text-gray-800 w-full rounded-xl border border-gray-200 p-5 shadow-lg">
      ...
      {currentItems?.length > 0 ? (
        <>
          {currentItems.map((item) => (
            <div
              ...
              className="flex justify-between p-4 items-center mb-2 cursor-pointer bg-gray-50 hover:bg-blue-50 rounded-lg transition-all"
            >
        ...
        <div className="text-gray-700 font-semibold text-lg">No projects assigned to you</div>
      )}
    </div>
  );
}
