...
export default function SecuritySetting() {
  ...
  return (
   <div className="w-full max-w-lg mx-auto p-4 sm:p-6 border border-gray-200 rounded-lg bg-white shadow-sm">
  ...
  <div className="space-y-4">
    ...
    <button
      ...
      disabled={loading}
      className="w-full sm:w-auto mt-2 px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
    >
